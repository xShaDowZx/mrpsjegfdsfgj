...
client.on('message' , async (message) => {
  ...
  if (args[0] === undefined) {
    ...
    const embed = new Discord.RichEmbed()
    .setColor("FFFFFF")
    .setDescription("**Provide a __language__ and some __text__ for bot to translate.**\n```Example:  *translate japanese Hello```");
    ...
    if (args[1] === undefined) {
      ...
      return message.channel.send('**Please write __something__ to translate.** ```Example:  *translate japanese Hello```');
