...
client.on('message', msg => { 
    if (msg.content.startsWith('*warn')) {
      ...
      if (!msg.mentions.members.first()) return msg.reply('**mention a user/player ```Exp: *warn @unknown1547 spamming```**')
...
client.on("message", function(message) {
   ...
   if(message.content.startsWith(prefix + "ban")) {
       ...
       if(!toBan) return message.reply("**# - Mention a user! ```Exp: *ban @unknown1547 spamming```**");
...
client.on('message',function(message) {
   ...
   if(message.content.startsWith(prefix + 'kick')) {
       ...
       if(!toReason) return message.reply("**# - Mention a user!  ```Exp: *kick @unknown1547 spamming```**")
